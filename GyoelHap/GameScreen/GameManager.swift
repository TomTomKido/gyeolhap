...
extension GameManager {
    func getOXQuestion(isHap: Bool) -> [Int] {
        ...
        let colors: [Int] = getColors(array: [randomNumber1, randomNumber2])
        let shapes: [Int] = getShapes(array: [randomNumber1, randomNumber2])
        let BGColors: [Int] = getBGColors(array: [randomNumber1, randomNumber2])
